namespace PlusOne
{
    ...
    /// </summary>
    internal sealed class PlusOneService : MonoBehaviour
    {
        private const string TokenFileName = "PlusOneToken.txt";
        ...
        /// </summary>
        public static PlusOneService Instance { get; private set; }
