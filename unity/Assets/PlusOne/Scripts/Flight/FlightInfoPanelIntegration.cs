    ...
    internal static class FlightInfoPanelIntegration
    {
        ...
        private static GroupModel BuildGroup()
        {
            ...
            group.Add(new ToggleModel(
                "Enabled",
                () => PlusOneService.Instance != null && PlusOneService.Instance.IsRunning,
                enabled => PlusOneService.Instance?.ToggleEnabled(),
                null));
            ...
            {
                addressLabel.Label = PlusOneService.Instance?.ConnectionAddress ?? "Not running";
            };
            ...
            group.Add(new TextButtonModel(
                ...
                _ =>
                {
                    var address = PlusOneService.Instance?.ConnectionAddress;
